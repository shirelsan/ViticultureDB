...
**ביצענו הינדוס לאחור** של מערכת ייצור יין, כדי להבין את מבנה הנתונים ואת היחסים בין הישויות.
...
נפרט פה על השינויים העיקריים שעשינו:

ראשית מה שנשאר אותו דבר זה מכיוון שלא היה שייך ליצור קשרים בין היישויות האלו.  
