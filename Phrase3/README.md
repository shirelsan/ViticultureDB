...
שינוי שלישי שעשינו זה הכנסת employee לworker מכיוון שבemployee היה את כל הששדות שיש לנו בworker ואפילו בworker יש לנו שדה נוסף של שנת תחילת עבודה החלטנו לעשות כך. 
